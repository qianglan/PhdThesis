%*********************第五章******************
\chapter{OpenCL Kernel程序的性能移植性提升方法}
\section{引言}
...
\begin{table}[htb]
	...
	\fbox{\includegraphics[width=12cm]{scaleaspect.pdf}}
	\label{orgkernel}
\end{table}
...
\fbox{\includegraphics[width=10cm]{scaleaspect.pdf}}
...
\begin{figure}
	\centering
	\includegraphics[width=10.5cm]{scaleaspect.pdf}
	\caption{依赖性分析示意图}
	\label{dependence}
\end{figure}
...
\begin{figure}[htb]
\centering
\includegraphics[width=12cm]{scaleaspect.pdf}
...
\begin{table}[htb]
	...
	\fbox{\includegraphics[width=10.5cm]{scaleaspect.pdf}}
	\label{cpuoutput}
\end{table}
