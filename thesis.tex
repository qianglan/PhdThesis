...
\UDC{004.93}
\title{高性能视觉跟踪关键技术研究}
\displaytitle{高性能视觉跟踪关键技术研究}
\author{黄达飞}
\zhdate{二〇一七\ 年\ 四\ 月}
\entitle{Research on Key Techniques for High-Performance Visual Tracking}
\enauthor{HUANG Dafei}
\endate{April 22, 2017}
\subject{计算机科学与技术}
\ensubject{Computer Science and Technology}
\researchfield{计算机系统结构}
\supervisor{张春元\quad{}教授}
%\cosupervisor{王五\quad{}副教授} % 没有就空着
\ensupervisor{Prof. ZHANG Chunyuan}
%\encosupervisor{}
\papertype{工学}
